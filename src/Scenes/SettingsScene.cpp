...
namespace HJ {
	...
	void SettingsScene::HandleInput()
	{
		...
		if (m_data->input.isClicked(backComp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(saveComp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(uncheck1Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(uncheck2Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(uncheck3Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(uncheck4Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(uncheck5Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(up1Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(down1Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(up2Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(down2Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(up3Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
		...
		if (m_data->input.isClicked(down3Comp->GetSprite(), sf::Mouse::Left, Renderer::GetWin()))
		{
